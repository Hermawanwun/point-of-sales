...
function StatCard({
    ...
    return (
        <div
            className={`
            group relative overflow-hidden rounded-[28px] p-5
            bg-gradient-to-br ${gradient}
            text-white shadow-[0_20px_50px_-18px_rgba(15,23,42,0.45)]
        `}
        >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.22),transparent_34%),linear-gradient(135deg,rgba(255,255,255,0.08),transparent_48%)]" />
            <div className="absolute inset-[1px] rounded-[27px] border border-white/15" />
            <div
                className={`absolute -bottom-12 right-[-10%] h-36 w-36 rounded-full blur-3xl ${accent}`}
            />

            {/* Background Pattern */}
            <div className="absolute top-0 right-0 w-32 h-32 opacity-20 transition-transform duration-500 group-hover:scale-110">
                <Icon
                    size={128}
                    strokeWidth={0.5}
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-2 mb-3">
                    <div className="p-2 rounded-2xl bg-white/16 backdrop-blur-md ring-1 ring-white/20 shadow-lg shadow-slate-950/10">
...
function TargetCard({ title, current, target, icon: Icon }) {
    ...
    return (
        <div className="group relative overflow-hidden rounded-[28px] p-5 bg-gradient-to-br from-[#4573ff] via-[#4f5eff] to-[#273fcb] text-white shadow-[0_20px_50px_-18px_rgba(15,23,42,0.45)]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.24),transparent_34%),linear-gradient(145deg,rgba(255,255,255,0.08),transparent_50%)]" />
            <div className="absolute inset-[1px] rounded-[27px] border border-white/15" />
            ...
            <div className="relative z-10">
                ...
                <p className="text-2xl font-bold tracking-tight">{percentage.toFixed(0)}%</p>

                {/* Progress Bar */}
                <div className="mt-3 w-full h-2 bg-white/20 rounded-full overflow-hidden ring-1 ring-inset ring-white/10">
                    <div
            ...
            <div className="space-y-6">
                ...
                {/* <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <StatCard
                        ...
                        icon={IconCoin}
                        gradient="from-[#2f6bff] via-[#2354f5] to-[#182ea8]"
                    ...
                    <StatCard
                        ...
                        icon={IconTrendingUp}
                        gradient="from-[#0ea5c6] via-[#1468d4] to-[#1732a3]"
                    ...
                    <StatCard
                        ...
                        subtitle="Transaksi"
                        icon={IconClock}
                        gradient="from-[#3b82f6] via-[#275df0] to-[#173baf]"
